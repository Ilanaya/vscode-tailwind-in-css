...
export const getTextNormalizedEol = (document: vscode.TextDocument) => document.getText().split(/\r?\n/).join('\n')
...
export const waitForJsonDiagnostics = async (document: vscode.TextDocument) =>
